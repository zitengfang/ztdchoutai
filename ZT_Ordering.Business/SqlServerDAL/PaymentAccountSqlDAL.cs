...
{
   public  class PaymentAccountSqlDAL:IPaymentAccount
    {
        public PaymentAccountSqlDAL()
        { }
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from PaymentAccount");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into PaymentAccount(");
            strSql.Append("merchantCode,name,enable,account)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update PaymentAccount set ");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from PaymentAccount ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
                    new SqlParameter("@id", SqlDbType.Int,4)
            };
        ...
        public PaymentAccount GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,merchantCode,name,enable,account from PaymentAccount ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
                    new SqlParameter("@id", SqlDbType.Int,4)
            };
            ...
            PaymentAccount model = new PaymentAccount();
        ...
        /// 得到一个对象实体
        /// </summary>
        public PaymentAccount DataRowToModel(DataRow row)
        {
            PaymentAccount model = new PaymentAccount();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,merchantCode,name,enable,account ");
            strSql.Append(" FROM PaymentAccount ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,merchantCode,name,enable,account ");
            strSql.Append(" FROM PaymentAccount ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from PaymentAccount T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "PaymentAccount";
